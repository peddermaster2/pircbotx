...
public class OutputChannel implements GenericChannelUserOutput {
	...
	public void message(UserHostmask user, String message) {
		if (user == null) throw new IllegalArgumentException("Can\'t send message to null user");
	...
	public void invite(Channel otherChannel) {
		if (otherChannel == null) throw new IllegalArgumentException("Can\'t send invite to null invite channel");
	...
	public void invite(@NonNull String target) {
		if (target == null) {
			throw new java.lang.NullPointerException("target");
		}
	...
	public void setMode(String mode) {
		if (mode == null) throw new IllegalArgumentException("Can\'t set mode on channel to null");
	...
	public void setMode(String mode, Object... args) {
		if (mode == null) throw new IllegalArgumentException("Can\'t set mode on channel to null");
		if (args == null) throw new IllegalArgumentException("Can\'t set mode arguments to null");
	...
	public void setMode(String mode, UserHostmask user) {
		if (mode == null) throw new IllegalArgumentException("Can\'t set user mode on channel to null");
	...
	public void ban(String hostmask) {
		if (hostmask == null) throw new IllegalArgumentException("Can\'t set ban on null hostmask");
	...
	public void setTopic(String topic) {
		if (topic == null) throw new IllegalArgumentException("Can\'t set topic to null");
	...
	public void kick(UserHostmask user, String reason) {
		if (user == null) throw new IllegalArgumentException("Can\'t kick null user");
		bot.sendRaw().rawLine("KICK " + channel.getName() + " " + user.getNick() + " :" + reason);
	}

	@java.beans.ConstructorProperties({"bot", "channel"})
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public OutputChannel(@NonNull final PircBotX bot, @NonNull final Channel channel) {
		if (bot == null) {
