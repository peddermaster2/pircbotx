...
public class OutputUser implements GenericChannelUserOutput {
	...
	@java.beans.ConstructorProperties({"bot", "serverUser"})
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public OutputUser(@NonNull final PircBotX bot, @NonNull final UserHostmask serverUser) {
		if (bot == null) {
			throw new java.lang.NullPointerException("bot");
		}
		if (serverUser == null) {
			throw new java.lang.NullPointerException("serverUser");
		}
		this.bot = bot;
