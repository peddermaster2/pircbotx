...
public class OutputRaw {
	...
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OutputRaw.class);
	...
	@java.beans.ConstructorProperties({"bot", "delayNanos"})
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public OutputRaw(@NonNull final PircBotX bot, final long delayNanos) {
		if (bot == null) {
