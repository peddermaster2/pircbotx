...
public class UtilSSLSocketFactory extends SSLSocketFactory {
	...
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UtilSSLSocketFactory.class);
	...
	public UtilSSLSocketFactory trustAllCertificates() {
		if (wrappedFactoryChanged) throw new RuntimeException("Cannot combine trustAllCertificates() and disableDiffieHellman(SSLSocketFactory)");
	...
	public UtilSSLSocketFactory disableDiffieHellman(SSLSocketFactory sourceSocketFactory) {
		if (trustingAllCertificates) throw new RuntimeException("Cannot combine trustAllCertificates() and disableDiffieHellman(SSLSocketFactory)");
	...
	protected SSLSocket prepare(Socket socket) {
		...
		if (diffieHellmanDisabled) {
			...
			for (String suite : sslSocket.getEnabledCipherSuites()) if (!suite.contains("_DHE_")) limited.add(suite);
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof UtilSSLSocketFactory)) return false;
		final UtilSSLSocketFactory other = (UtilSSLSocketFactory)o;
		if (!other.canEqual((java.lang.Object)this)) return false;
		final java.lang.Object this$wrappedFactory = this.wrappedFactory;
		final java.lang.Object other$wrappedFactory = other.wrappedFactory;
		if (this$wrappedFactory == null ? other$wrappedFactory != null : !this$wrappedFactory.equals(other$wrappedFactory)) return false;
		if (this.isTrustingAllCertificates() != other.isTrustingAllCertificates()) return false;
		if (this.isDiffieHellmanDisabled() != other.isDiffieHellmanDisabled()) return false;
		if (this.wrappedFactoryChanged != other.wrappedFactoryChanged) return false;
		return true;
	}
	...
	public int hashCode() {
		final int PRIME = 59;
		int result = 1;
		final java.lang.Object $wrappedFactory = this.wrappedFactory;
		result = result * PRIME + ($wrappedFactory == null ? 0 : $wrappedFactory.hashCode());
		result = result * PRIME + (this.isTrustingAllCertificates() ? 79 : 97);
		result = result * PRIME + (this.isDiffieHellmanDisabled() ? 79 : 97);
		result = result * PRIME + (this.wrappedFactoryChanged ? 79 : 97);
		return result;
	}
