...
public class RemoveInviteOnlyEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "RemoveInviteOnlyEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof RemoveInviteOnlyEvent)) return false;
		final RemoveInviteOnlyEvent other = (RemoveInviteOnlyEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof RemoveInviteOnlyEvent;
	}
