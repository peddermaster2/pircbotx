...
public class SetChannelLimitEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "SetChannelLimitEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ", limit=" + this.getLimit() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof SetChannelLimitEvent)) return false;
		final SetChannelLimitEvent other = (SetChannelLimitEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof SetChannelLimitEvent;
	}
