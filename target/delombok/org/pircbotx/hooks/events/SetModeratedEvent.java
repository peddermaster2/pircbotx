...
public class SetModeratedEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "SetModeratedEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof SetModeratedEvent)) return false;
		final SetModeratedEvent other = (SetModeratedEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof SetModeratedEvent;
	}
