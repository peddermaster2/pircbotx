...
public class SetPrivateEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "SetPrivateEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof SetPrivateEvent)) return false;
		final SetPrivateEvent other = (SetPrivateEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof SetPrivateEvent;
	}
