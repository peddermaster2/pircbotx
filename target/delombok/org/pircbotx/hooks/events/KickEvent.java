...
public class KickEvent extends Event implements GenericChannelModeRecipientEvent {
	...
	public KickEvent(PircBotX bot, @NonNull Channel channel, @NonNull UserHostmask userHostmask, User user, @NonNull UserHostmask recipientHostmask, User recipient, @NonNull String reason) {
		super(bot);
		if (channel == null) {
	...
	public java.lang.String toString() {
		return "KickEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ", recipientHostmask=" + this.getRecipientHostmask() + ", recipient=" + this.getRecipient() + ", reason=" + this.getReason() + ")";
	}
