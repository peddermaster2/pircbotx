...
public class VoiceEvent extends Event implements GenericChannelModeRecipientEvent {
	...
	public VoiceEvent(PircBotX bot, @NonNull Channel channel, @NonNull UserHostmask userHostmask, User user, @NonNull UserHostmask recipientHostmask, User recipient, boolean hasVoice) {
		super(bot);
		if (channel == null) {
	...
	public java.lang.String toString() {
		return "VoiceEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ", recipientHostmask=" + this.getRecipientHostmask() + ", recipient=" + this.getRecipient() + ", hasVoice=" + this.hasVoice + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof VoiceEvent)) return false;
		final VoiceEvent other = (VoiceEvent)o;
		...
		if (this.hasVoice != other.hasVoice) return false;
		return true;
	}
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof VoiceEvent;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.hasVoice ? 79 : 97);
		return result;
	}
