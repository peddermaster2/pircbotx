...
public class HalfOpEvent extends Event implements GenericChannelModeRecipientEvent {
	...
	public java.lang.String toString() {
		return "HalfOpEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ", recipientHostmask=" + this.getRecipientHostmask() + ", recipient=" + this.getRecipient() + ", isHalfOp=" + this.isHalfOp() + ")";
	}
