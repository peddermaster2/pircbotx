...
public class RemoveNoExternalMessagesEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "RemoveNoExternalMessagesEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof RemoveNoExternalMessagesEvent)) return false;
		final RemoveNoExternalMessagesEvent other = (RemoveNoExternalMessagesEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof RemoveNoExternalMessagesEvent;
	}
