...
public class RemoveSecretEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "RemoveSecretEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof RemoveSecretEvent)) return false;
		final RemoveSecretEvent other = (RemoveSecretEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof RemoveSecretEvent;
	}
