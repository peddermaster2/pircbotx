...
public class SetNoExternalMessagesEvent extends Event implements GenericChannelModeEvent {
	...
	public java.lang.String toString() {
		return "SetNoExternalMessagesEvent(channel=" + this.getChannel() + ", userHostmask=" + this.getUserHostmask() + ", user=" + this.getUser() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof SetNoExternalMessagesEvent)) return false;
		final SetNoExternalMessagesEvent other = (SetNoExternalMessagesEvent)o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof SetNoExternalMessagesEvent;
	}
